...
[CreateAssetMenu(fileName = "Collector Upgrade Data", menuName = "Create Collector Upgrade Data")]
public class CollectorUpgradeSO : ScriptableObject
{
...
[Serializable]
public class CollectorDataList
{
    public float Speed;
    public float Range;
}
