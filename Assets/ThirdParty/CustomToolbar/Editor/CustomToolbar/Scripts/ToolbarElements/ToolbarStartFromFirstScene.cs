...
internal class ToolbarStartFromFirstScene : BaseToolbarElement {
	...
	public override void Init() {
		...
		startFromFirstSceneBtn = new GUIContent((Texture2D)AssetDatabase.LoadAssetAtPath($"Assets/ThirdParty/CustomToolbar/Editor/CustomToolbar/Icons/PlayIcon.png", typeof(Texture2D)), "Start from 1 scene");
	}
